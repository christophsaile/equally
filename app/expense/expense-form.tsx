        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              "toggleClasses": "hs-select-disabled:pointer-events-none hs-select-disabled:opacity-50 relative py-3 ps-4 pe-9 flex gap-x-2 text-nowrap w-full cursor-pointer bg-white border border-gray-200 rounded-lg text-start text-sm focus-style dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400",
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              name="amount"
              required
              className="focus-style block w-full rounded-lg border-gray-200 px-4 py-3 pe-16 ps-9 text-sm shadow-sm focus:z-10 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500"
              placeholder="0.00"
              step="0.01"
              min="0"
              defaultValue={amount}
