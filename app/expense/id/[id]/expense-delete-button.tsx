...
export function ExpenseDeleteButton({ children, ...props }: Props) {
  ...
  return (
    <>
      <div className="fixed bottom-[78px] left-0 right-0 m-auto mb-4 grid w-full max-w-lg grid-cols-2 gap-4 px-4">
        <div></div>
        <button
          type="button"
          className="focus-style right-0 inline-flex items-center gap-x-2 rounded-lg border border-transparent bg-red-500 px-4 py-3 text-base font-medium text-white hover:bg-red-600 focus:bg-red-600 disabled:pointer-events-none disabled:opacity-50"
